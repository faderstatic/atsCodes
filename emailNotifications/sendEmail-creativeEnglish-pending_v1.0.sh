...
export recipient1=testCreativeEnglish@olympusat.com
...
#Email Body
subject="MAM - English Creative - Pending - $title"
body="Hi,

A new original title, [$title], is now Pending English Creative.
...
echo "$datetime - (creativeEnglish) - Sending Email" >> "$logfile"
echo "$datetime - (creativeEnglish) - To - $recipient1, $recipient2, $recipient3, $recipient4" >> "$logfile"
echo "$datetime - (creativeEnglish) - From - $emailFrom" >> "$logfile"
echo "$datetime - (creativeEnglish) - Subject - $subject" >> "$logfile"
echo "$datetime - (creativeEnglish) - Body - $body" >> "$logfile"
...
echo "$datetime - (creativeEnglish) - Email Sent" >> "$logfile"
