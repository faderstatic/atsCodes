...
export recipient1=testCreativeSpanish@olympusat.com
...
#Email Body
subject="MAM - Spanish Creative - Pending - $title"
body="Hi,

A new original title, [$title], is now Pending Spanish Creative.
...
echo "$datetime - (creativeSpanish) - Sending Email" >> "$logfile"
echo "$datetime - (creativeSpanish) - To - $recipient1, $recipient2, $recipient3, $recipient4" >> "$logfile"
echo "$datetime - (creativeSpanish) - From - $emailFrom" >> "$logfile"
echo "$datetime - (creativeSpanish) - Subject - $subject" >> "$logfile"
echo "$datetime - (creativeSpanish) - Body - $body" >> "$logfile"
...
echo "$datetime - (creativeSpanish) - Email Sent" >> "$logfile"
