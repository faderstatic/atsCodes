...
export recipient1=testDubbingSpanish@olympusat.com
...
#Email Body
subject="MAM - Spanish Dubbing - Pending - $title"
body="Hi,

A new original title, [$title], is now Pending Spanish Dubbing.
...
echo "$datetime - (dubbingSpanish) - Sending Email" >> "$logfile"
echo "$datetime - (dubbingSpanish) - To - $recipient1, $recipient2, $recipient3, $recipient4" >> "$logfile"
echo "$datetime - (dubbingSpanish) - From - $emailFrom" >> "$logfile"
echo "$datetime - (dubbingSpanish) - Subject - $subject" >> "$logfile"
echo "$datetime - (dubbingSpanish) - Body - $body" >> "$logfile"
...
echo "$datetime - (dubbingSpanish) - Email Sent" >> "$logfile"
