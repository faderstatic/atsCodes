...
then
    ...
    #curl -v --url 'smtp://smtp-mail.outlook.com:587' --ssl-reqd  --mail-from $sesFromAddress --mail-rcpt $sesToAddress --mail-rcpt $recipient1  --user 'notify@olympusat.com:6bOblVsLg9bPQ8WG7JC7f8Zump' -F '=(;type=multipart/mixed' -F "=$sesMessage;type=text/plain" -F "file=@$sesFile;type=$sesMIMEType;encoder=base64" -F '=)' -H "Subject: $sesSubject"
