...
then
    ...
    then
        ...
        sleep 2
        echo "ItemId,FileName,Title,ContentType,VersionType,FileExtension,FrameRate,ContentFlags" >> "$newItemFileDestination"
    ...
    echo "$itemId,$itemOriginalFilename,$itemTitle,$itemContentType,$itemVersionType,$itemOriginalExtension,$originalShapeFrameRate,$itemContentFlags" >> "$newItemFileDestination"
    sleep 2
