		...
		then
			...
			then
				...
				then
					...
					bash -c "sudo /opt/olympusat/scriptsActive/notificationWorkflow-sendEmailWithReport_v2.6.sh newItem > /dev/null 2>&1 &"

					# Trigger Send Email for originalContentQCPending Workflow
					bash -c "sudo /opt/olympusat/scriptsActive/notificationWorkflow-sendEmailWithReport_v2.6.sh originalContentQCPending > /dev/null 2>&1 &"

					# Trigger Send Email for finalQCPending Workflow
					bash -c "sudo /opt/olympusat/scriptsActive/notificationWorkflow-sendEmailWithReport_v2.6.sh finalQCPending > /dev/null 2>&1 &"

					# Trigger Send Email for finalQCPending Workflow
					bash -c "sudo /opt/olympusat/scriptsActive/notificationWorkflow-sendEmailWithReport_v2.6.sh markedToBeDeleted > /dev/null 2>&1 &"
					
					# Trigger Send Email for rtcMexicoQcPending Workflow
					bash -c "sudo /opt/olympusat/scriptsActive/notificationWorkflow-sendEmailWithReport_v2.6.sh rtcReviewPending > /dev/null 2>&1 &"
					
					# Trigger Send Email for rtcMexicoQc Workflow
					bash -c "sudo /opt/olympusat/scriptsActive/notificationWorkflow-sendEmailWithReport_v2.6.sh rtcReviewCompleted > /dev/null 2>&1 &"
