...
then
    ...
    Duration - $formattedTime" >> "$collectionItemsInfo"
            ...
            then
                ...
                subNameOfEpisode=$(echo "$collectionItemTitleEn")
            ...
            then
                ...
                subNameOfEpisode=$(echo "$collectionItemTitleEs")
            ...
            echo "$(date +%Y/%m/%d_%H:%M:%S) - (spWorkflow) - ($collectionId) - Email Subject Line - MAM - S&P Report - [$subNameOfEpisode] - ($subSeasonEpisode) - {$subRightslineItemId}" >> "$logfile"
            ...
            subject="MAM - S&P Report - [$subNameOfEpisode] - ($subSeasonEpisode) - {$subRightslineItemId}"
            body="Hi,
