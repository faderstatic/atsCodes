...
echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++" >> $logfile
echo "$(date +%Y/%m/%d_%H:%M:%S) - (rtcMexicoQC) - ($itemId) - Triggering API to Update rtcMexicoQCStatus Metadata" >> "$logfile"
echo "$(date +%Y/%m/%d_%H:%M:%S) - (rtcMexicoQC) - ($itemId) - Item ID - $itemId" >> "$logfile"
echo "$(date +%Y/%m/%d_%H:%M:%S) - (rtcMexicoQC) - ($itemId) - New QC Status - $qcStatus" >> "$logfile"
...
echo "$(date +%Y/%m/%d_%H:%M:%S) - (rtcMexicoQC) - ($itemId) - Body Data - $bodyData" >> "$logfile"
...
echo "$(date +%Y/%m/%d_%H:%M:%S) - (rtcMexicoQC) - ($itemId) - URL - $permissionUrl" >> "$logfile"
echo "$(date +%Y/%m/%d_%H:%M:%S) - (rtcMexicoQC) - ($itemId) - Body Data - $permissionBodyData" >> "$logfile"
