...
echo "Cantemo Item ID - [$cantemoItemId]"
echo "Column Header - [$columnHeader]"
...
then
    ...
    echo "itemIdColumn - [$itemIdColumn]"
    ...
    do
        ...
        echo "cantemoItemId - [$cantemoItemId]"
    ...
    then
        ...
        fileDestination=$(echo "/opt/olympusat/xmlsForMetadataImport/rightslineItemId_$cantemoItemId.xml")
