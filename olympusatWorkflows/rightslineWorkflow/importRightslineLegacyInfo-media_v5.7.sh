...
export inputFile="$4"
export rightslineDealsContracts="$5"
...
then
    ...
    then
        ...
        IFS=$oldIFS
        apiPayload="$apiPayload       <field>\n           <name>oly_contractCode</name>\n         <value>$cantemoContractCode</value>\n      </field>\n"
        echo "Update Contract Code: $rightslineContractId - $cantemoContractCode"
    fi
    # --------------------------------------------------
