...
urlGetItemInfo="http://10.1.1.34:8080/API/item/$itemId/metadata?field=oly_adminRulesFlags&terse=yes"
...
if [[ "$httpResponse" != *"rightslineinfoimported"* ]];
then
    partialRow="false"
  ...
  <group>Olympusat</group>
    <timespan end=\"+INF\" start=\"-INF\">
      <field>
        ...
        updateVidispineMetadata $itemId "oly_adminRulesFlags" "rightslineinfoimported"
