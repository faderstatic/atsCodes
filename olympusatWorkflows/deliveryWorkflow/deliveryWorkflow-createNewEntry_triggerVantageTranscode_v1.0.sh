...
then
    ...
    triggerTranscodeBody="csrfmiddlewaretoken=7lh7lzhsoOv6vgLv3Tf32thK5UbhhgPa55sokrd5vkfxrhzMEEhSufhT84FecpBQ&format=Vantage_Submit&search_id_selected=&selected_collection=&selected_items=$itemId&ignored_items="
