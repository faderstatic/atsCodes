...
then
    ...
    then
        ...
        echo "$datetime - (copyMetadataToOtherMasters) - [$itemId] - Searching for Textless Master - [$originalSearchTitle]" >> "$logfile"
        ...
        echo "$datetime - (copyMetadataToOtherMasters) - [$itemId] - Textless Check Hit Results - [$textlessCheckHitResults]" >> "$logfile"
        if [ "$textlessCheckHitResults" -gt 1 ];
        then
            echo "$datetime - (copyMetadataToOtherMasters) - [$itemId] - Textless Master Search Results Returned MORE THAN 1 Hit - Trying different search" >> "$logfile"
            ...
            echo "$datetime - (copyMetadataToOtherMasters) - [$itemId] - Second Textless Check Hit Results - [$textlessCheckHitResults]" >> "$logfile"
            if [ "$textlessCheckHitResults" -gt 1 ];
            then
                echo "$datetime - (copyMetadataToOtherMasters) - [$itemId] - Textless Master Search Results Returned MORE THAN 1 Hit-skipping process" >> "$logfile"
            else
        ...
        echo "$datetime - (copyMetadataToOtherMasters) - [$itemId] - Searching for Dubbed Master - [$originalSearchTitle]" >> "$logfile"
        export searchUrl="http://10.1.1.34/API/v2/search/"
        ...
        echo "$datetime - (copyMetadataToOtherMasters) - [$itemId] - Dubbed Master Check Hit Results - [$dubbedCheckHitResults]" >> "$logfile"
        if [ "$dubbedCheckHitResults" -gt 1 ];
        then
            echo "$datetime - (copyMetadataToOtherMasters) - [$itemId] - Dubbed Master Search Results Returned MORE THAN 1 Hit - Trying different search" >> "$logfile"
            ...
            echo "$datetime - (copyMetadataToOtherMasters) - [$itemId] - Second Dubbed Master Check Hit Results - [$dubbedCheckHitResults]" >> "$logfile"
            if [ "$dubbedCheckHitResults" -gt 1 ];
            then
                echo "$datetime - (copyMetadataToOtherMasters) - [$itemId] - Dubbed Master Search Results Returned MORE THAN 1 Hit-skipping process" >> "$logfile"
            else
        ...
        echo "$datetime - (copyMetadataToOtherMasters) - [$itemId] - Searching for Spanish Master - [$originalSearchTitle]" >> "$logfile"
        export searchUrl="http://10.1.1.34/API/v2/search/"
        ...
        echo "$datetime - (copyMetadataToOtherMasters) - [$itemId] - Spanish Master Check Hit Results - [$spanishCheckHitResults]" >> "$logfile"
        if [ "$spanishCheckHitResults" -gt 1 ];
        then
            echo "$datetime - (copyMetadataToOtherMasters) - [$itemId] - Spanish Master Search Results Returned MORE THAN 1 Hit - Trying different search" >> "$logfile"
            ...
            echo "$datetime - (copyMetadataToOtherMasters) - [$itemId] - Second Spanish Master Check Hit Results - [$spanishCheckHitResults]" >> "$logfile"
            if [ "$spanishCheckHitResults" -gt 1 ];
            then
                echo "$datetime - (copyMetadataToOtherMasters) - [$itemId] - Spanish Master Search Results Returned MORE THAN 1 Hit-skipping process" >> "$logfile"
            else
    ...
    then
        ...
        echo "$datetime - (copyMetadataToOtherMasters) - [$itemId] - Content Type is NOT 'episode' nor 'movie'" >> "$logfile"
        echo "$datetime - (copyMetadataToOtherMasters) - [$itemId] - Content Type is [$itemContentType] - Skipping Copy Metadata to Other Masters Workflow" >> "$logfile"
    fi
fi
IFS=$saveIFS
