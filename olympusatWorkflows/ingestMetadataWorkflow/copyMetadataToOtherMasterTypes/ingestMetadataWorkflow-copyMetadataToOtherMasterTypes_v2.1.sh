...
echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$itemId] - Copy Metadata to Other Masters Initiated" >> "$logfile"
...
then
    ...
    then
        ...
        then
            ...
            echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$itemId] - Textless Master does not exist - Trying different search - [$searchTitle]" >> "$logfile"
            export searchUrl="http://10.1.1.34/API/v2/search/"
            ...
            then
                ...
                then
                    ...
                    #echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$textlessItemId] - Update Textless Body - [$updateTextlessBody]" >> "$logfile"
                    ...
                    #echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$textlessItemId] - Update Textless HTTP Response - [$updateTextlessHttpResponse]" >> "$logfile"
        ...
        then
            ...
            searchTitle=$(echo $searchTitle1 "*_S"$itemSeasonNumber"E"$itemEpisodeNumber"_*")
            echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$itemId] - Dubbed Master ES does not exist - Trying different search - [$searchTitle]" >> "$logfile"
            export searchUrl="http://10.1.1.34/API/v2/search/"
            ...
            then
                ...
                then
                    ...
                    #echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$dubbedEsItemId] - Update Dubbed Es Body - [$updateTextlessBody]" >> "$logfile"
                    ...
                    #echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$dubbedEsItemId] - Update Dubbed Es HTTP Response - [$updateTextlessHttpResponse]" >> "$logfile"
        ...
        then
            ...
            searchTitle=$(echo $searchTitle1 "*_S"$itemSeasonNumber"E"$itemEpisodeNumber"_*")
            echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$itemId] - Dubbed Master EN does not exist - Trying different search - [$searchTitle]" >> "$logfile"
            export searchUrl="http://10.1.1.34/API/v2/search/"
            ...
            then
                ...
                then
                    ...
                    #echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$dubbedEnItemId] - Update Dubbed En Body - [$updateTextlessBody]" >> "$logfile"
                    ...
                    #echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$dubbedEnItemId] - Update Dubbed En HTTP Response - [$updateTextlessHttpResponse]" >> "$logfile"
        ...
        then
            ...
            #searchTitle="$searchTitle1 S'$itemSeasonNumber'E'$itemEpisodeNumber'"
            searchTitle=$(echo $searchTitle1 "*_S"$itemSeasonNumber"E"$itemEpisodeNumber"_*")
            echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$itemId] - Spanish Master does not exist - Trying different search - [$searchTitle]" >> "$logfile"
            export searchUrl="http://10.1.1.34/API/v2/search/"
            ...
            then
                ...
                then
                    ...
                    #echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$spanishItemId] - Update Spanish Master Body - [$updateTextlessBody]" >> "$logfile"
                    ...
                    #echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$spanishItemId] - Update Spanish Master HTTP Response - [$updateTextlessHttpResponse]" >> "$logfile"
        ...
        echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$itemId] - Searching for English Master - [$originalSearchTitle]" >> "$logfile"
        export searchUrl="http://10.1.1.34/API/v2/search/"
        ...
        #echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$itemId] - English Master Check Body - [$englishCheckBody]" >> "$logfile"        
        ...
        #echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$itemId] - English Master Check HTTP Response - [$englishCheckHttpResponse]" >> "$logfile"
        echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$itemId] - English Master Check Hit Results - [$englishCheckHitResults]" >> "$logfile"
        if [ "$englishCheckHitResults" -gt 1 ];
        then
            echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$itemId] - English Master Search Results Returned MORE THAN 1 Hit - Trying different search" >> "$logfile"
            # English Master does not exist - trying different search
            #searchTitle="$searchTitle1 S'$itemSeasonNumber'E'$itemEpisodeNumber'"
            searchTitle=$(echo $searchTitle1 "*_S"$itemSeasonNumber"E"$itemEpisodeNumber"_*")
            echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$itemId] - English Master does not exist - Trying different search - [$searchTitle]" >> "$logfile"
            export searchUrl="http://10.1.1.34/API/v2/search/"
            englishCheckBody="{ \"filter\": { \"operator\": \"AND\",\"terms\": [{ \"name\": \"title\", \"value\": \"$searchTitle\" },{ \"name\": \"oly_originalFileFlags\", \"value\": \"englishmaster\" }]}}"
            #echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$itemId] - Second English Master Check Body - [$englishCheckBody]" >> "$logfile"                
            englishCheckHttpResponse=$(curl --location --request PUT $searchUrl --header 'Content-Type: application/json' --header 'Authorization: Basic YWRtaW46MTBsbXBAc0B0' --header 'Cookie: csrftoken=VDa9RP3Y9rgomyzNWvRxbu7WdTMetVYBlLg6pGMIJ6oyVABsjJiiEK9JCWVA1HYd' --data $englishCheckBody)
            englishCheckHitResults=$(echo $englishCheckHttpResponse | awk -F '"hits":' '{print $2}' | awk -F ',' '{print $1}')
            #echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$itemId] - Second English Master Check HTTP Response - [$englishCheckHttpResponse]" >> "$logfile"
            echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$itemId] - Second English Master Check Hit Results - [$englishCheckHitResults]" >> "$logfile"
            if [ "$englishCheckHitResults" -gt 1 ];
            then
                echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$itemId] - English Master Search Results Returned MORE THAN 1 Hit-skipping process" >> "$logfile"
            else
                ...
                then
                    ...
                    echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$itemId] - English Master Item ID - [$englishItemId]" >> "$logfile"
                    # Updating metadata on English Master Item
                    echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$itemId] - Updating Metadata on English Master Item - [$englishItemId]" >> "$logfile"
                    ...
                    #echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$englishItemId] - Update English Master Body - [$updateTextlessBody]" >> "$logfile"
                    ...
                    #echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$englishItemId] - Update English Master HTTP Response - [$updateTextlessHttpResponse]" >> "$logfile"
                    #updateVidispineMetadata $englishItemId "oly_titleEs" "$itemTitleEs"
                    #updateVidispineMetadata $englishItemId "oly_titleEn" "$itemTitleEn"
                    #updateVidispineMetadata $englishItemId "oly_originalTitle" "$itemOriginalTitle"
                    #updateVidispineMetadata $englishItemId "oly_seriesName" "$itemSeriesName"
                    #updateVidispineMetadata $englishItemId "oly_seasonNumber" "$itemSeasonNumber"
                    #updateVidispineMetadata $englishItemId "oly_episodeNumber" "$itemEpisodeNumber"
                    #updateVidispineMetadata $englishItemId "oly_licensor" "$itemLicensor"
                    #updateVidispineMetadata $englishItemId "oly_titleCode" "$itemTitleCode"
                    #updateVidispineMetadata $englishItemId "oly_contractCode" "$itemContractCode"
                    #updateVidispineMetadata $englishItemId "oly_originalLanguage" "$itemOriginalLanguage"                    
                else
                    # English Master does not exist
                    echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$itemId] - English Master does not exist" >> "$logfile"
                fi
            fi
        else
            if [[ "$englishCheckHttpResponse" == *'"id":"OLY-'* ]];
    ...
    then
        ...
        then
            ...
            sleep 2
            # API Call to Search for English Master
            echo "$(date +%Y/%m/%d_%H:%M) - (copyMetadataToOtherMasters) - [$itemId] - Searching for English Master - [$searchTitle]" >> "$logfile"
            export searchUrl="http://10.1.1.34/API/v2/search/"
