...
#Email Body
subject="MAM - Original Content QC - Pending - $title"
body="Hi,

A new original title, [$title], is now Pending Original Content QC.
...
echo "$datetime - (originalQC) - Sending Email" >> "$logfile"
echo "$datetime - (originalQC) - To - $recipient1, $recipient2, $recipient3, $recipient4, $recipient5" >> "$logfile"
echo "$datetime - (originalQC) - From - $emailFrom" >> "$logfile"
echo "$datetime - (originalQC) - Subject - $subject" >> "$logfile"
echo "$datetime - (originalQC) - Body - $body" >> "$logfile"
...
echo "$datetime - (originalQC) - Email Sent" >> "$logfile"
